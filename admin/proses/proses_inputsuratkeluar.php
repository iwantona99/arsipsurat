<?php
    ...
    if (!($tgl_keluar=='') and !($kode_suratkeluar =='') and !($nomor_suratkeluar =='') and !($tgl_surat =='') and !($kepada_suratkeluar =='') and !($perihal_suratkeluar =='') and !($operator =='') and !($tanggal_entry =='') and   
		...
		$sql = "INSERT INTO tb_suratkeluar(tanggalkeluar_suratkeluar, kode_suratkeluar, nomor_suratkeluar, tanggalsurat_suratkeluar, kepada_suratkeluar, perihal_suratkeluar, file_suratkeluar, operator, tanggal_entry)
				values ('$tgl_keluar', '$kode_suratkeluar', '$nomor_suratkeluar', '$tgl_surat', '$kepada_suratkeluar', '$perihal_suratkeluar', '$nama_baru', '$operator', '$tanggal_entry')";
